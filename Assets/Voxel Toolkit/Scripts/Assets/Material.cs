...
namespace VoxelToolkit
{
    ...
    public struct TransformedMaterial
    {
        ...
        public TransformedMaterial(Material material, float hueShift, float saturation, float brightness)
        {
            MaterialType = material.MaterialType;

            UnityEngine.Color.RGBToHSV(material.color, out float h, out float s, out float v);
            ...
            var color = UnityEngine.Color.HSVToRGB(h + hueShift, s * saturation, newBrightness);
